...
const Layout = ({ children }) => {
  return (
    <div className="container flex">
      <div className="sidebar-container w-44 min-h-screen bg-black pt-5">
        <svg
        ...
        <div className="icons-wrapper flex flex-col items-center">
          <div className="icon-wrapper w-12 h-12 rounded-full mt-32 flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
          ...
          <div className="icon-wrapper w-12 h-12 rounded-full mt-3 flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              className="w-5 mx-auto"
